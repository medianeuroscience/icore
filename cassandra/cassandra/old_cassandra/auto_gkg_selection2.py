...
daterange = [datetime.today().replace(hour=0,minute=0,second=0,microsecond=0)-timedelta(x) for x in range(5,8)] 
...
import datetime
pickle.dump(data_dict, open('gkg_{}_2.pkl'.format(datetime.date.today()), 'wb'))
